...
house3 = House(floors=4, doors=15, windows=20,color="Green", has_garage=False, address="4526 Broadfish Road" )
...
house1.paint_house("Purple")
house1.add_garage()
house2.add_garage()  
house2.set_address("4526 BroadFish Road")
house3.paint_house("Blue")
house3.set_address("123 Main St")
house3.add_garage()
